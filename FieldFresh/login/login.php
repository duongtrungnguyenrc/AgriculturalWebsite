            ...
            <form action="login.php" method="post" class="w-100 register">
              ...
              <div class="form-group mb-2">
                  <div class="input-group">
                      ...
                      <select class="form-select" name="rg-province" id="rg-province" required>
                          <option value="" disabled selected>Chose province</option>
                      </select>
                  </div>
                  <div class="input-group">
                      <span class="input-group-text"><i class='bx bxs-credit-card-front'></i></span>
                      <select class="form-select" name="rg-district" id="rg-district" required>
                          <option value="" disabled selected>Chose district</option>
                      </select>
                  </div>
              </div>
              ...
              <div class="form-group mb-2">
                  <div class="input-group">
                      ...
                      <select class="form-select" name="rg-ward" id="rg-ward" required>
                          <option value="" disabled selected>Chose ward</option>
                      </select>
                  </div>
                  <div class="input-group">
                      <span class="input-group-text"><i class='bx bx-current-location'></i></span>
                      <input type="text" class="form-control rounded-right" placeholder="Address" name="rg-address" id="rg-address" required>
                  </div>
              </div>
              ...
              <div class="form-group mb-2">
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control rounded-right" placeholder="Email" name="rg-email" id="rg-email" required>
                  </div>
                  <div class="input-group">
              ...
              <div class="form-group mb-2">
                <div class="input-group">
                  ...
                  <input type="password" class="form-control rounded-right" placeholder="Password" name="rg-password" id="rg-password" required>
                </div>
                <div class="input-group">
                  <span class="input-group-text"><i class='bx bxs-lock' ></i></span>
                    <input type="password" class="form-control rounded-right" placeholder="Confirm password" name="rg-confirm" id="rg-confirm" required>
                </div>
              </div>
